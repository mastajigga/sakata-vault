...
export const UI_TRANSLATIONS = {
  ...
  hero: {
    eyebrow: {
      fr: "Patrimoine du Mai-Ndombe",
      skt: "Nsoni ya Mai-Ndombe",
      lin: "Libula ya Mai-Ndombe",
      swa: "Urithi wa Mai-Ndombe",
      tsh: "Bumpianyi bwa Mai-Ndombe",
    },
    title: {
      fr: "L'âme du peuple Sakata dans la brume du Mai-Ndombe",
      skt: "Nsoni ya basakata o nsoni ya Mai-Ndombe",
      lin: "Molimo ya bato ya Sakata na mbonge ya Mai-Ndombe",
      swa: "Roho ya watu wa Sakata katika ukungu wa Mai-Ndombe",
      tsh: "Anyima wa bantu ba Sakata mu kifu kya Mai-Ndombe",
    },
    subtitle: {
      fr: "Transmission des savoirs ancestraux, de la langue et de la sagesse éternelle.",
      skt: "Komema mayele ya bakoko, nsoni na bwanya o tina.",
      lin: "Kopesa boyebi ya ba nkoko, monoko na mayele ya seko.",
      swa: "Kurithisha maarifa ya mababu, lugha na hekima ya milele.",
      tsh: "Diyisha dya manyinu a kale, tshiakula ne meji a tshiendelele.",
    },
    cta: {

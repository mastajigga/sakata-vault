    ...
    etapes: [
      {
        ...
        titre: "Salutations",
        slug: "salutations",
        description: "Mbote, Tókó, Lóbí — les premiers mots",
        icone: "👋",
        debloquee: true,
        completee: false,
      },
      {
        ...
        titre: "La Famille",
        slug: "famille",
        description: "Tatá, Mamá, Nkókó — les liens sacrés",
        icone: "👨‍👩‍👧",
        debloquee: false,
        completee: false,
      },
      {
        ...
        titre: "Se présenter",
        slug: "se-presenter",
        description: "Nkómbó na ngáí... — Je m'appelle...",
        icone: "🗣️",
        debloquee: false,
        completee: false,
      },
    ...
    etapes: [
      {
        ...
        titre: "La Nourriture",
        slug: "nourriture",
        description: "Mákémbá, Nsósó, Mbísi — aliments du terroir",
        icone: "🍲",
        debloquee: false,
        completee: false,
      },
      {
        ...
        titre: "Les Couleurs",
        slug: "couleurs",
        description: "Ntáne, Mbwé, Ngóla — la palette Sakata",
        icone: "🎨",
        debloquee: false,
        completee: false,
      },
      {
        ...
        slug: "nombres",
        description: "Mókó, Íbalé, Ísátó... — les nombres",
        icone: "🔢",
        debloquee: false,
        completee: false,
      },
    ...
    etapes: [
      {
        ...
        slug: "actions",
        description: "Kotámbola, Kolía, Kolála — au quotidien",
        icone: "🏃",
        debloquee: false,
        completee: false,
      },
      {
        ...
        titre: "Le Temps",
        slug: "temps",
        description: "Lóbí, Lélo, Mái — hier, aujourd'hui, demain",
        icone: "⏳",
        debloquee: false,
        completee: false,
      },
      {
        ...
        titre: "Lieux & Nature",
        slug: "lieux",
        description: "Zámba, Ebale, Mbóka — forêt, rivière, village",
        icone: "🌿",
        debloquee: false,
        completee: false,
      },
    ...
    etapes: [
      {
        ...
        titre: "Proverbes",
        slug: "proverbes",
        description: "La sagesse des anciens en une phrase",
        icone: "📜",
        debloquee: false,
        completee: false,
      },
      {
        ...
        titre: "Récits",
        slug: "recits",
        description: "Raconter une histoire en Kisakata",
        icone: "📖",
        debloquee: false,
        completee: false,
      },
      {
        ...
        titre: "Chants & Poésie",
        slug: "chant",
        description: "Le rythme et la musicalité de la langue",
        icone: "🎵",
        debloquee: false,
        completee: false,
      },
...
function RiviereSvg() {
  return (
    ...
    >
      ...
      {/* Courbe sinueuse de la rivière */}
      <path
        d="M0,300 C200,100 300,500 500,300 C700,100 800,500 1000,300 C1100,200 1150,250 1200,280"
        fill="none"
...
export default function RiviereLangue() {
  ...
  return (
    <section id="methode" className="relative py-24 overflow-hidden">
      ...
      <div className="relative section-container" ref={containerRef}>
        {/* En-tête */}
        <motion.div
        ...
        >
          ...
          <p className="mt-4 text-[rgba(212,221,215,0.72)] max-w-2xl mx-auto">
            Chaque niveau est une étape sur la rivière. Débloquez les leçons une
            à une, comme on remonte le courant de la Lukenie.
          </p>
        </motion.div>
          ...
          {NIVEAUX_RIVIERE.map((niveau, idx) => (
            <button
              ...
              className={`px-5 py-2.5 rounded-full text-sm font-medium transition-all duration-500 ${
                niveauActif === idx
                  ? "bg-[rgba(196,160,53,0.2)] border border-[rgba(196,160,53,0.4)] text-[var(--or-ancestral)]"
                  : "border border-[rgba(212,221,215,0.08)] text-[rgba(212,221,215,0.6)] hover:border-[rgba(212,221,215,0.2)]"
              }`}
            >
              <span
                className="inline-block w-2 h-2 rounded-full mr-2"
                style={{ background: niveau.couleur }}
              />
              {niveau.nom}
            </button>
          ))}
          ...
          {NIVEAUX_RIVIERE[niveauActif].etapes.map((etape, idx) => (
            ...
            >
              {etape.debloquee ? (
                ...
                >
                  {/* Icône */}
                  <div className="w-12 h-12 rounded-xl bg-[rgba(196,160,53,0.08)] flex items-center justify-center mb-4 text-2xl group-hover:scale-110 transition-transform">
                    {etape.icone}
                  </div>
                  ...
                  <p className="mt-2 text-sm text-[rgba(212,221,215,0.64)] leading-relaxed">
                    {etape.description}
                  </p>
                  ...
                  {/* Badge complété */}
                  {etape.completee && (
                    <div className="absolute top-4 right-4 w-6 h-6 rounded-full bg-[var(--or-ancestral)]/20 border border-[var(--or-ancestral)] flex items-center justify-center">
                      <span className="text-xs">✓</span>
                    </div>
                  )}
                </Link>
              ) : (
                <div className="block h-full rounded-[1.5rem] border border-[rgba(212,221,215,0.04)] bg-[rgba(10,31,21,0.2)] p-6 opacity-60 cursor-not-allowed">
                  <div className="w-12 h-12 rounded-xl bg-[rgba(212,221,215,0.04)] flex items-center justify-center mb-4 text-2xl grayscale">
                    {etape.icone}
                  </div>
                  <h3 className="text-lg font-display text-[rgba(212,221,215,0.4)]">
                    {etape.titre}
                  </h3>
                  <p className="mt-2 text-sm text-[rgba(212,221,215,0.3)] leading-relaxed">
                    {etape.description}
                  </p>
                  <div className="mt-4 flex items-center gap-2 text-xs text-[rgba(212,221,215,0.2)]">
          ...
          <div className="h-1.5 rounded-full bg-[rgba(212,221,215,0.06)] overflow-hidden">
            <motion.div
              ...
              style={{
                ...
                width: `${((niveauActif) / (NIVEAUX_RIVIERE.length - 1)) * 100}%`,
              }}
            />
          </div>
          <p className="text-center text-xs text-[rgba(212,221,215,0.4)] mt-3">

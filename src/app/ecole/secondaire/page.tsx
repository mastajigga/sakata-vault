  ...
  return (
    <div className="min-h-screen bg-[#0a0f16] text-white pt-24 pb-12 px-4 sm:px-6 lg:px-8 overflow-hidden relative font-sans">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none z-0">
        <div className="absolute -top-[10%] -right-[10%] w-[50%] h-[50%] bg-ivoire-ancien/10 blur-[130px] rounded-full" />
        <div className="absolute bottom-[10%] -left-[10%] w-[40%] h-[40%] bg-or-ancestral/10 blur-[120px] rounded-full" />
      </div>
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between mb-12 gap-6">
          ...
          >
            <Link 
              href="/ecole"
              className="group flex items-center gap-2 text-ivoire-ancien hover:text-ivoire-ancien transition-colors mb-4"
            >
            ...
            <h1 className="text-4xl md:text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-or-ancestral to-ivoire-ancien flex items-center gap-4">
              <Binary className="w-10 h-10 text-ivoire-ancien" />
              Le Monde Secondaire
            </h1>
        ...
        {!selectedYear ? (
              ...
              >
                ...
                >
                  <div className="flex justify-between items-start mb-4">
                    <div className="w-12 h-12 rounded-xl bg-ivoire-ancien/10 flex items-center justify-center group-hover:bg-ivoire-ancien/15 transition-colors">
                      <BookOpen className="w-6 h-6 text-ivoire-ancien" />
                    </div>
                    <span className="text-[10px] uppercase tracking-[0.2em] text-ivoire-ancien/60 font-bold border border-ivoire-ancien/15 px-2 py-1 rounded">
                      Advanced
                    </span>
                  </div>

                  <div className="mt-auto">
                    <div className="text-ivoire-ancien text-sm font-semibold mb-1">
                      {year.degree}
                    </div>
                  ...
                  {/* Glass effect hover */}
                  <div className="absolute inset-0 bg-gradient-to-br from-ivoire-ancien/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none" />
                </motion.div>
              </Link>
            ))}
          </motion.div>
          ...
          >
            <div className="mb-10 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <div>
                <span className="inline-block px-3 py-1 rounded-full bg-ivoire-ancien/10 text-ivoire-ancien text-[10px] font-bold uppercase tracking-wider mb-2">
                  Session d'apprentissage active
                </span>
                <h2 className="text-3xl font-bold text-white">{selectedYear.title}</h2>
              </div>
              <div className="flex items-center gap-3 text-ivoire-ancien text-sm bg-ivoire-ancien/5 px-4 py-2 rounded-xl border border-ivoire-ancien/10">
      ...
      <div className="max-w-7xl mx-auto mt-16 text-center">
        <div className="h-px w-24 bg-gradient-to-r from-transparent via-or-ancestral/40 to-transparent mx-auto mb-6" />
        <p className="text-gray-500 text-sm">
          Besoin d'aide technique ? Visite <Link href="/help/ecole" className="text-ivoire-ancien hover:underline">l'Espace Help École</Link>
        </p>
      </div>
    </div>
  );

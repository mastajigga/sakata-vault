...
export const metadata: Metadata = {
  title: "4e Secondaire — Cours complet | Kisakata École",
  description:
    "Trigonométrie, logarithmes, géométrie analytique et vecteurs — parcours animé ancré dans la culture Basakata.",
};

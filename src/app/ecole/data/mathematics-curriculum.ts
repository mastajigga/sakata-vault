...
export const secondairePrograms: MathematicsProgramYear[] = [
  ...
  // PRIMAIRE 1 - Ages 5-6
  {
    ...
    courseChapters: [
      { id: "p1-ch1", title: "Compter de 1 à 5", subtitle: "Les premiers nombres", exerciseIds: [], sakataContext: "Au débarcadère, on compte les pirogues.", visualizations: [{ type: "number-line", title: "Ligne des nombres", description: "Placer 1, 2, 3, 4, 5 sur la droite" }, { type: "place-value-grid", title: "Grille", description: "Chaque case représente un objet compté" }, { type: "statistics-bars", title: "Barres de comptage", description: "Une barre par quantité : 1 pirogue, 2 pirogues, 3 pirogues..." }, { type: "area-rectangle", title: "Rangées", description: "Disposer les objets en rangées pour compter" }], theoryBlocks: [{ title: "Le nombre 1", explanation: "Un seul objet.", formula: "1", example: "Une pirogue." }] },
      { id: "p1-ch2", title: "Les chiffres", subtitle: "Les signes écrits", exerciseIds: [], sakataContext: "Le marchand écrit les prix en chiffres.", visualizations: [{ type: "balance", title: "Chiffre = quantité", description: "Le chiffre 3 et les 3 paniers se correspondent : même poids sur la balance" }, { type: "number-line", title: "Chiffres et nombres", description: "Chaque chiffre trouve sa place sur la droite numérique" }, { type: "place-value-grid", title: "Visualiser", description: "Associer le signe écrit à sa représentation en objets" }, { type: "area-rectangle", title: "Grille", description: "Disposer autant d'objets que le chiffre l'indique" }], theoryBlocks: [{ title: "Un chiffre", explanation: "Signe écrit qui représente un nombre.", formula: "3 = trois", example: "Trois paniers." }] },
      { id: "p1-ch3", title: "Les formes", subtitle: "Cercle, carré, triangle", exerciseIds: [], sakataContext: "Le panier carré, le tambour rond, le toit triangulaire.", visualizations: [{ type: "area-rectangle", title: "Le carré", description: "4 côtés égaux : le panier carré du village" }, { type: "fraction-circle", title: "Le cercle", description: "Forme ronde sans angles : le tambour, le soleil" }, { type: "statistics-bars", title: "Compter les formes", description: "Combien de carrés, de ronds, de triangles dans notre village ?" }, { type: "place-value-grid", title: "Classer les formes", description: "Ranger chaque objet dans la case de sa forme" }], theoryBlocks: [{ title: "Le cercle", explanation: "Forme ronde, sans coins.", formula: "Cercle", example: "Le soleil." }] },
      { id: "p1-ch4", title: "Avant et après", subtitle: "L'ordre des événements", exerciseIds: [], sakataContext: "Le pêcheur rentre le matin, sa prise sèche, la famille cuisine le soir.", visualizations: [{ type: "timeline", title: "Chronologie", description: "Matin → Midi → Soir : l'ordre de la journée du pêcheur" }, { type: "number-line", title: "Avant/après", description: "Sur la droite : ce qui vient avant est à gauche, après est à droite" }, { type: "place-value-grid", title: "Séquences", description: "Chaque case = une étape : quelle étape vient en 1er, en 2e, en 3e ?" }, { type: "area-rectangle", title: "Bandes", description: "Bandes illustrées placées dans le bon ordre chronologique" }], theoryBlocks: [{ title: "L'ordre", explanation: "Avant → Après.", formula: "Avant → Après", example: "Matin → Jour → Soir." }] },
      { id: "p1-ch5", title: "Jusqu'à 10", subtitle: "Les deux mains", exerciseIds: [], sakataContext: "L'enfant compte sur ses dix doigts. 5 + 5 = 10.", visualizations: [{ type: "number-line", title: "1 à 10", description: "Tous les nombres de 1 à 10 sur la droite" }, { type: "place-value-grid", title: "Dix unités", description: "Dix cases remplies une par une jusqu'au groupe complet" }, { type: "area-rectangle", title: "Deux mains", description: "5 doigts + 5 doigts : deux rangées de cinq font dix" }, { type: "statistics-bars", title: "Barres de 1 à 10", description: "Chaque barre grandit : 1, 2, 3... jusqu'à 10" }], theoryBlocks: [{ title: "Dix", explanation: "Un groupe complet. Les dix doigts.", formula: "10", example: "Dix pièces de monnaie." }] },
    ],
  },
  // PRIMAIRE 2
  { slug: "primaire-2", title: "Primaire 2", degree: "Degré élémentaire", focus: "Ajouter et retirer, argent", overview: "L'enfant approfondit le calcul.", learningObjectives: ["Additionner et soustraire jusqu'à 20.", "Utiliser la monnaie locale."], localContexts: ["pièces", "tissu", "trajet", "récolte"], theoryBlocks: [], exercises: [], courseSlug: "primaire-2", courseChapters: [
    { id: "p2-ch1", title: "Additionner", subtitle: "Deux groupes", exerciseIds: [], sakataContext: "Au marché.", visualizations: [{ type: "number-line", title: "Sauts", description: "Voir" }, { type: "area-rectangle", title: "Groupes", description: "Réunir" }, { type: "place-value-grid", title: "Unités", description: "Ajouter" }, { type: "balance", title: "Équilibre", description: "Équilibre" }], theoryBlocks: [{ title: "L'addition", explanation: "Deux groupes ensemble.", formula: "a + b = c", example: "8 + 7 = 15." }] },
    { id: "p2-ch2", title: "Soustraire", subtitle: "Enlever", exerciseIds: [], sakataContext: "Douze poissons.", visualizations: [{ type: "number-line", title: "Sauts", description: "Retrait" }, { type: "area-rectangle", title: "Enlever", description: "Retirer" }, { type: "place-value-grid", title: "Unités", description: "Enlever" }, { type: "balance", title: "Équilibre", description: "Nouveau" }], theoryBlocks: [{ title: "Soustraction", explanation: "Enlever une partie.", formula: "a - b = c", example: "15 - 7 = 8." }] },
    { id: "p2-ch3", title: "L'argent", subtitle: "Pièces", exerciseIds: [], sakataContext: "Marché.", visualizations: [{ type: "place-value-grid", title: "Pièces", description: "Chaque case représente une pièce et sa valeur" }, { type: "number-line", title: "Prix", description: "Placer les prix sur la droite pour les comparer" }, { type: "area-rectangle", title: "Grille", description: "Ranger les pièces par valeur : 1F, 5F, 10F" }, { type: "balance", title: "Prix = paiement", description: "Le prix de l'objet s'équilibre avec les pièces posées en face" }], theoryBlocks: [{ title: "Pièces", explanation: "Chaque pièce a une valeur.", formula: "1 = 1 franc", example: "Trois pièces de 5 = 15." }] },
    { id: "p2-ch4", title: "Mesurer", subtitle: "Corps", exerciseIds: [], sakataContext: "Tissu.", visualizations: [{ type: "number-line", title: "Mesure", description: "Chaque pas ou empan marque un point sur la droite de mesure" }, { type: "area-rectangle", title: "Rectangle", description: "Longueur d'un tissu représentée comme un rectangle à mesurer" }, { type: "place-value-grid", title: "Compter", description: "Compter le nombre de pas ou de coudées dans la distance" }, { type: "statistics-bars", title: "Comparer les mesures", description: "Comparer la taille du puits, du champ, du trajet en barres" }], theoryBlocks: [{ title: "Corps", explanation: "L'empan, le pas, la coudée.", formula: "Distance = nombre de pas", example: "Puits à 50 pas." }] },
    { id: "p2-ch5", title: "Problèmes", subtitle: "Histoires", exerciseIds: [], sakataContext: "Mangues.", visualizations: [{ type: "timeline", title: "Histoire en étapes", description: "Situation de départ → Ce qui se passe → Question finale" }, { type: "number-line", title: "Chemin de la solution", description: "Partir du nombre initial, sauter vers la réponse" }, { type: "place-value-grid", title: "Données du problème", description: "Inscrire chaque donnée dans une case avant de calculer" }, { type: "area-rectangle", title: "Avant/Après", description: "Rectangle avant : situation initiale. Rectangle après : résultat" }], theoryBlocks: [{ title: "Lire", explanation: "Lire, identifier, choisir.", formula: "Histoire → Opération → Réponse", example: "6 − 2 = 4." }] },
  ] },
  // PRIMAIRE 3
  { slug: "primaire-3", title: "Primaire 3", degree: "Degré moyen", focus: "Valeur de position, multiplication", overview: "Dix unités = une dizaine.", learningObjectives: ["Nombres jusqu'à 100.", "Dizaines et unités.", "Multiplier.", "Diviser."], localContexts: ["régimes", "nasses", "sacs", "poissons"], theoryBlocks: [], exercises: [], courseSlug: "primaire-3", courseChapters: [
    { id: "p3-ch1", title: "Dizaines et unités", subtitle: "Compter par 10", exerciseIds: [], sakataContext: "Débarcadère.", visualizations: [{ type: "place-value-grid", title: "Grille", description: "Colonne dizaines / colonne unités : 3 dizaines et 2 unités = 32" }, { type: "number-line", title: "Sauts", description: "Sauts de 10 en 10 sur la droite : 10, 20, 30..." }, { type: "area-rectangle", title: "Blocs", description: "Un bloc de 10 cases représente une dizaine" }, { type: "statistics-bars", title: "Barres par dizaine", description: "10, 20, 30... en barres croissantes pour visualiser les paquets de 10" }], theoryBlocks: [{ title: "Dizaine", explanation: "10 objets = 1 paquet.", formula: "10 = 1 dizaine", example: "10 filets = 1 groupe." }] },
    { id: "p3-ch2", title: "Addition", subtitle: "Avec dizaines", exerciseIds: [], sakataContext: "28 + 4.", visualizations: [{ type: "place-value-grid", title: "Grille", description: "Dizaines" }, { type: "number-line", title: "Sauts", description: "Addition" }, { type: "area-rectangle", title: "Zones", description: "Regrouper" }, { type: "balance", title: "Équilibre", description: "Avant" }], theoryBlocks: [{ title: "Addition", explanation: "Quand unités >= 10, dizaine.", formula: "27 + 5 = 32", example: "7 + 5 = 12." }] },
    { id: "p3-ch3", title: "Multiplication", subtitle: "Plusieurs fois", exerciseIds: [], sakataContext: "4 nasses.", visualizations: [{ type: "area-rectangle", title: "Grille", description: "4 rangées de 3 cases = 12 au total : voir la multiplication comme une grille" }, { type: "place-value-grid", title: "Rangées", description: "Chaque rangée est un groupe de même taille" }, { type: "number-line", title: "Sauts", description: "Sauts égaux de 3 en 3 : 0, 3, 6, 9, 12" }, { type: "balance", title: "Multiplication = additions répétées", description: "4 × 3 pèse pareil que 3 + 3 + 3 + 3 sur la balance" }], theoryBlocks: [{ title: "Multiplier", explanation: "4 × 3 = 3 + 3 + 3 + 3.", formula: "4 × 3 = 12", example: "4 nasses × 3 = 12." }] },
    { id: "p3-ch4", title: "Division", subtitle: "Parts égales", exerciseIds: [], sakataContext: "12 mangues.", visualizations: [{ type: "area-rectangle", title: "Grille", description: "Partager" }, { type: "place-value-grid", title: "Colonnes", description: "Parts" }, { type: "fraction-circle", title: "Parts", description: "Partage" }, { type: "number-line", title: "Sauts", description: "Combien fois" }], theoryBlocks: [{ title: "Diviser", explanation: "12 ÷ 3 = 4.", formula: "12 ÷ 3 = 4", example: "12 poissons ÷ 4." }] },
    { id: "p3-ch5", title: "Deux opérations", subtitle: "Combiner", exerciseIds: [], sakataContext: "3 pirogues.", visualizations: [{ type: "balance", title: "Résultat intermédiaire", description: "Le résultat de l'étape 1 s'équilibre avant d'entrer dans l'étape 2" }, { type: "number-line", title: "Chemin", description: "Deux sauts successifs sur la droite : d'abord ×4 puis −5" }, { type: "place-value-grid", title: "Chaque étape", description: "Une colonne par étape : résultat intermédiaire bien séparé" }, { type: "area-rectangle", title: "Zones", description: "Décomposer le problème en deux zones rectangulaires distinctes" }], theoryBlocks: [{ title: "Deux étapes", explanation: "Étape 1 → Étape 2.", formula: "Étape 1 → Étape 2", example: "3 × 4 = 12, puis 12 − 5 = 7." }] },
  ] },
  // PRIMAIRE 4
  { slug: "primaire-4", title: "Primaire 4", degree: "Degré moyen", focus: "Tables, fractions, géométrie", overview: "Tables 2 à 5. Fractions.", learningObjectives: ["Tables 2-5.", "Fractions 1/2, 1/3, 1/4.", "Périmètres."], localContexts: ["tissu", "parcelles", "enclos", "récoltes"], theoryBlocks: [], exercises: [], courseSlug: "primaire-4", courseChapters: [
    { id: "p4-ch1", title: "Tables", subtitle: "Mémoriser 2 à 5", exerciseIds: [], sakataContext: "4 rangées.", visualizations: [{ type: "area-rectangle", title: "Grilles", description: "Grille de la table : 4 lignes × 3 colonnes = 12" }, { type: "statistics-bars", title: "Progression en barres", description: "2, 4, 6, 8, 10... : chaque barre est deux de plus que la précédente" }, { type: "number-line", title: "Sauts", description: "Bonds réguliers de 2 en 2, de 3 en 3 sur la droite" }, { type: "place-value-grid", title: "Groupes", description: "Chaque multiplication correspond à un nombre de groupes égaux" }], theoryBlocks: [{ title: "Table 2", explanation: "2, 4, 6, 8...", formula: "2 × n", example: "2 pirogues × 3." }] },
    { id: "p4-ch2", title: "Fractions", subtitle: "Moitié, tiers, quart", exerciseIds: [], sakataContext: "Tissu.", visualizations: [{ type: "fraction-circle", title: "Parts", description: "Parts" }, { type: "area-rectangle", title: "Rectangle", description: "Diviser" }, { type: "place-value-grid", title: "Unités", description: "Parts" }, { type: "number-line", title: "Fractions", description: "Fractions" }], theoryBlocks: [{ title: "Moitié", explanation: "Couper 2.", formula: "1/2", example: "Pomme." }] },
    { id: "p4-ch3", title: "Périmètres", subtitle: "Tour des formes", exerciseIds: [], sakataContext: "Enclos.", visualizations: [{ type: "area-rectangle", title: "Contour", description: "Tracer le contour du rectangle et mesurer chaque côté" }, { type: "number-line", title: "Mesure", description: "Additionner les longueurs des côtés sur la droite numérique" }, { type: "statistics-bars", title: "Longueur de chaque côté", description: "Une barre par côté : comparer et additionner visuellement" }, { type: "place-value-grid", title: "Somme des côtés", description: "Inscrire la mesure de chaque côté dans une case et faire la somme" }], theoryBlocks: [{ title: "Périmètre", explanation: "Distance autour.", formula: "P = a + b + c + d", example: "Rectangle." }] },
    { id: "p4-ch4", title: "Formes", subtitle: "Triangles et rectangles", exerciseIds: [], sakataContext: "Toit.", visualizations: [{ type: "area-rectangle", title: "Rectangle", description: "4 côtés : 2 longueurs et 2 largeurs égaux deux à deux" }, { type: "fraction-circle", title: "Triangle", description: "3 côtés qui délimitent une surface triangulaire" }, { type: "number-line", title: "Côtés", description: "Mesurer et comparer la longueur de chaque côté sur la droite" }, { type: "place-value-grid", title: "Propriétés des formes", description: "Tableau : nombre de côtés, angles, symétries pour chaque forme" }], theoryBlocks: [{ title: "Triangle", explanation: "3 côtés.", formula: "3 côtés", example: "Toit." }] },
    { id: "p4-ch5", title: "Intérêt simple", subtitle: "Argent augmente", exerciseIds: [], sakataContext: "100 francs.", visualizations: [{ type: "number-line", title: "Croissance du capital", description: "Voir le capital grandir mois après mois sur la droite : 100, 110, 120..." }, { type: "area-rectangle", title: "Capital", description: "Le rectangle représente le capital : sa largeur grandit avec les intérêts" }, { type: "timeline", title: "Évolution dans le temps", description: "Mois 1 → Mois 2 → Mois 3 : l'argent augmente à chaque échéance" }, { type: "place-value-grid", title: "Tableau des intérêts", description: "Une colonne par mois : capital de départ, intérêt du mois, total cumulé" }], theoryBlocks: [{ title: "Intérêt", explanation: "On reçoit intérêt chaque mois.", formula: "Intérêt = Capital × Taux", example: "100 F × 10 F." }] },
  ] },
  // PRIMAIRE 5
  { slug: "primaire-5", title: "Primaire 5", degree: "Degré moyen", focus: "Décimaux, fractions, surfaces", overview: "Décimaux. Fractions. Surface.", learningObjectives: ["Décimaux simples.", "Fractions numériques.", "Surface rectangle.", "Volumes."], localContexts: ["litres", "prix", "champs", "récipients"], theoryBlocks: [], exercises: [], courseSlug: "primaire-5", courseChapters: [
    { id: "p5-ch1", title: "Décimaux", subtitle: "Virgule et dixièmes", exerciseIds: [], sakataContext: "Tissu.", visualizations: [{ type: "place-value-grid", title: "Grille", description: "Colonne entiers | colonne dixièmes | colonne centièmes : 3,5 se décompose" }, { type: "number-line", title: "Droite", description: "Placer 3,5 entre 3 et 4 sur la droite numérique" }, { type: "area-rectangle", title: "Carrés", description: "Un carré entier et sa moitié : 1 + 0,5 = 1,5" }, { type: "balance", title: "3,5 = 3 + 0,5", description: "Le nombre décimal s'équilibre avec sa partie entière plus sa partie décimale" }], theoryBlocks: [{ title: "Virgule", explanation: "Sépare entiers.", formula: "3,5 = 3 + 0,5", example: "15,5 F." }] },
    { id: "p5-ch2", title: "Opérations décimales", subtitle: "Additionner", exerciseIds: [], sakataContext: "12,5 kg.", visualizations: [{ type: "number-line", title: "Sauts", description: "Ajouter" }, { type: "place-value-grid", title: "Colonnes", description: "Aligner" }, { type: "area-rectangle", title: "Blocs", description: "Blocs" }, { type: "balance", title: "Équilibre", description: "Décimal" }], theoryBlocks: [{ title: "Ajouter", explanation: "Aligner virgules.", formula: "12,5 + 8,3 = 20,8", example: "15,7 kg." }] },
    { id: "p5-ch3", title: "Fractions numériques", subtitle: "Lire 2/3, 3/4", exerciseIds: [], sakataContext: "Parcelle.", visualizations: [{ type: "fraction-circle", title: "Parts", description: "Parts" }, { type: "area-rectangle", title: "Rectangle", description: "Diviser" }, { type: "number-line", title: "Fractions", description: "Placer" }, { type: "place-value-grid", title: "Compter", description: "Compter" }], theoryBlocks: [{ title: "Lire", explanation: "3/4 : 4 dit combien.", formula: "3/4", example: "3/4 pomme." }] },
    { id: "p5-ch4", title: "Surface rectangle", subtitle: "Longueur × largeur", exerciseIds: [], sakataContext: "Champ.", visualizations: [{ type: "area-rectangle", title: "Grille", description: "Compter les cases à l'intérieur du rectangle : chaque case = 1 m²" }, { type: "place-value-grid", title: "Rangées", description: "Chaque rangée a autant de cases que la largeur" }, { type: "number-line", title: "Dimensions", description: "Placer la longueur et la largeur sur la droite pour les comparer" }, { type: "statistics-bars", title: "Surfaces comparées", description: "Comparer deux champs de dimensions différentes en barres de surface" }], theoryBlocks: [{ title: "Surface", explanation: "Surface = longueur × largeur.", formula: "S = L × l", example: "Champ." }] },
    { id: "p5-ch5", title: "Volumes et litres", subtitle: "Mesurer l'eau", exerciseIds: [], sakataContext: "Jarre.", visualizations: [{ type: "balance", title: "Équilibre des volumes", description: "2 litres + 3 litres pèsent pareil que 5 litres sur la balance" }, { type: "number-line", title: "Droite", description: "Placer 0,5 L, 1 L, 2 L, 5 L sur la droite des quantités" }, { type: "area-rectangle", title: "Conteneur", description: "Hauteur remplie dans le réservoir rectangulaire représente le volume" }, { type: "statistics-bars", title: "Comparaison de contenants", description: "Bol, verre, jarre, seau : comparer leurs volumes en barres" }], theoryBlocks: [{ title: "Litre", explanation: "1 L = 1 000 mL.", formula: "1 L = 1000 mL", example: "Jarre 5 L." }] },
  ] },
  // PRIMAIRE 6
  { slug: "primaire-6", title: "Primaire 6", degree: "Degré moyen", focus: "Pourcentages, proportions, géométrie", overview: "Pourcentages. Proportions. Graphiques.", learningObjectives: ["Pourcentages.", "Proportionnalité.", "Polygones.", "Lire graphiques."], localContexts: ["profit", "partage", "cartes", "statistiques"], theoryBlocks: [], exercises: [], courseSlug: "primaire-6", courseChapters: [
    { id: "p6-ch1", title: "Pourcentages", subtitle: "50% 25% 10%", exerciseIds: [], sakataContext: "Nasse.", visualizations: [{ type: "fraction-circle", title: "Cercle %", description: "50% = demi-cercle, 25% = quart de cercle : voir visuellement" }, { type: "area-rectangle", title: "Carré 100", description: "100 petites cases : colorier 50, 25 ou 10 pour voir le pourcentage" }, { type: "number-line", title: "Droite %", description: "Placer 10%, 25%, 50%, 75%, 100% sur la droite de 0 à 100" }, { type: "statistics-bars", title: "50%, 25%, 10% côte à côte", description: "Trois barres de hauteurs différentes : comparer 50%, 25%, 10% visuellement" }], theoryBlocks: [{ title: "Pourcentage", explanation: "Fraction sur 100.", formula: "% = Nombre/100", example: "25% de 200 = 50." }] },
    { id: "p6-ch2", title: "Proportionnalité", subtitle: "Grandeurs proportionnelles", exerciseIds: [], sakataContext: "1 kg poisson.", visualizations: [{ type: "statistics-bars", title: "Tableau de proportionnalité", description: "Visualiser deux grandeurs qui augmentent ensemble" }, { type: "number-line", title: "Valeurs", description: "Placer les valeurs proportionnelles sur une droite" }, { type: "fraction-circle", title: "Parts proportionnelles", description: "Voir les parts d'un tout proportionnel" }, { type: "area-rectangle", title: "Grille", description: "Représenter la proportionnalité par des rectangles" }], theoryBlocks: [{ title: "Proportion", explanation: "Une augmente, l'autre augmente.", formula: "x1/y1 = x2/y2", example: "2 pirogues = 2 pêcheurs." }] },
    { id: "p6-ch3", title: "Polygones", subtitle: "Carrés rectangles triangles", exerciseIds: [], sakataContext: "Terrain.", visualizations: [{ type: "area-rectangle", title: "Formes", description: "Surface intérieure du carré et du rectangle : L × l" }, { type: "fraction-circle", title: "Angles", description: "Visualiser les angles intérieurs d'un polygone" }, { type: "place-value-grid", title: "Propriétés des polygones", description: "Tableau de propriétés : nombre de côtés, angles égaux, symétries" }, { type: "number-line", title: "Mesures", description: "Mesurer et comparer la longueur des côtés sur la droite" }], theoryBlocks: [{ title: "Carré", explanation: "4 côtés égaux.", formula: "Carré", example: "Terrain 10×10." }] },
    { id: "p6-ch4", title: "Graphiques", subtitle: "Lire données visuellement", exerciseIds: [], sakataContext: "Tableau poissons.", visualizations: [{ type: "statistics-bars", title: "Graphique en barres", description: "Lire la hauteur de chaque barre : Lundi = 5 kg, Mardi = 8 kg de poissons" }, { type: "timeline", title: "Séries temporelles", description: "Données semaine par semaine : voir les variations de la récolte dans le temps" }, { type: "place-value-grid", title: "Tableau de données", description: "Lire et écrire les données dans un tableau avant de tracer le graphique" }, { type: "number-line", title: "Échelle du graphique", description: "Choisir l'échelle : une unité sur la droite = combien de kg ?" }], theoryBlocks: [{ title: "Graphique barres", explanation: "Hauteur = quantité.", formula: "Hauteur barre = Quantité", example: "Graphique." }] },
    { id: "p6-ch5", title: "Problèmes complexes", subtitle: "Réunir apprentissages", exerciseIds: [], sakataContext: "Pêcheur.", visualizations: [{ type: "statistics-bars", title: "Données du problème", description: "Représenter les données pour mieux les voir" }, { type: "number-line", title: "Calcul étape par étape", description: "Suivre chaque étape sur la droite numérique" }, { type: "area-rectangle", title: "Parts du problème", description: "Décomposer le problème en parties" }, { type: "timeline", title: "Étapes de résolution", description: "Lire → Identifier → Opérer → Répondre" }], theoryBlocks: [{ title: "Résoudre", explanation: "Lire → Identifier → Choisir → Calculer.", formula: "Données → Opérations", example: "60 kg, 50%." }] },
  ] },
];
